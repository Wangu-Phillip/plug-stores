            ...
            <div id="productTable">
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        $query = "SELECT p.id, p.name, p.description, p.category, p.price, p.size, p.color, p.image, s.id AS shop_id FROM products p,shops s WHERE p.shop_id = s.id AND s.owner_id = $manager_id";
