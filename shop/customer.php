...
<body>
    ...
    <!-- POPULAR SHOES SECTION START  -->
    <section class="py-5">
        <div class="container">
            <h2 class="text-center mb-5">Shoe Brands</h2>
            <div class="row">
                <!-- Shoe Card 1 -->
                <div class="col-md-4 mb-4">
                    <div class="rounded-2">
                        <div class="row g-0">
                            ...
                            <h5 class="text-center" id="shoe">Nike</h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 mb-4">
                    <div class="rounded-2">
                        <div class="row g-0">
                            <img src="../assets/shoe4.jpg" class="card-img product-image rounded-3" alt="shoe">
                            <h5 class="text-center" id="shoe">Addidas</h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 mb-4">
                    <div class="rounded-2">
                        <div class="row g-0">
                            <img src="../assets/shoe4.jpg" class="card-img product-image rounded-3" alt="shoe">
                            <h5 class="text-center" id="shoe">Puma</h5>
                        </div>
                    </div>
                </div>
            </div>
